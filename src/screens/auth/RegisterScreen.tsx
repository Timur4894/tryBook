    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{width: '100%'}}>
                <Text style={{fontSize: 16, fontFamily: 'Jost', color: colors.textSecondary}}>Full Name</Text>
            ...
            <View>
                <Text style={{fontSize: 16, fontFamily: 'Jost', color: colors.textSecondary, marginBottom: 8}}>
                    Already have an account? <TouchableOpacity onPress={() => {navigation.navigate('Login')}}><Text style={{color: colors.primary}}>Sign in</Text></TouchableOpacity>
                </Text>
